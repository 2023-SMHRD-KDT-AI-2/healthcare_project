    ...
    <div class="container">
      <div class="left-panel-active">
        ...
        <div class="container__form container--signup">
          <form action="#" class="form" id="memberJoinForm">
            <h2 class="form__title">회원 가입</h2>
            <input type="text" placeholder="이름" class="input" required="required" />
            <input type="email" placeholder="Email" class="input" required="required" />
            <input type="password" placeholder="비밀번호" class="input" required="required" /><input
              type="password"
              placeholder="비밀번호"
        ...
        <div class="container__form container--signin">
          ...
          <c:if test="${loginError != null}">
            ...
            <input type="hidden" name="c" value="generalLoginCheck" />
            <input type="hidden" name="loginType" value="member" />
            <input type="email" placeholder="Email" class="input" name="id" required="required" value="${email}"/>
            <input type="password" placeholder="비밀번호" class="input" name="password" required="required" />
            <a href="#" class="link">비밀번호를 잊어먹으셨습니까?</a>
