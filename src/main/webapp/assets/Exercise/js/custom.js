...
const loadmember = async () => {
    ...
    // 차트에서 쓸 쿨톤 색깔들
    let goodColor = ['#bc69fa', '#7386FF', '#5C9EF5', '#00E1FD', '#01F6D5', '#8258FA', '#5858FA'];
    ...
    for (let i = 0; i < exerciseInfo.length; i++) {
        ...
        dayExerciseCalList.push(parseInt(exerciseInfo[i].calorie));
    }
    ...
    const iClassdayExerciseKinds = [
        'fa fa-square fa_custom1',
        'fa fa-square fa_custom2',
        'fa fa-square fa_custom3',
        'fa fa-square fa_custom4',
        'fa fa-square fa_custom5',
        'fa fa-square fa_custom6',
        'fa fa-square fa_custom7',
    ];
